...
<body>
    <div class="container-lg batasatas page">
        <h3 style="text-align: center;margin-bottom:20px ">Faktur Pembelian</h3>

        <div><span>Nomor Nota</span><span style="margin-left: 24px; margin-right: 5px">:</span> </span> <span style="margin-left: 5px">{{$faktur[0]->nota}}</span> </div>
        <div><span>Nama Pembeli</span> <span style="margin-left: 5px; margin-right: 5px">:</span> <span style="margin-left: 5px">{{$faktur[0]->nama}}</span> </div>
    ...
    <div><span>Nomor Dokumen</span><span style="margin-left: 24px; margin-right: 5px">:</span> </span> <span style="margin-left: 5px">{{$faktur[0]->nota}}</span> <span style="margin-left:400px">Tanggal </span> <span>:</span>{{date('d-m-Y')}}</div>
